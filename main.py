...
from WGAN_GP_ADV import WGAN_GP_ADV
from WGAN_GP_ADV_vgg import WGAN_GP_ADV_vgg
...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='GAN',
                        choices=['GAN', 'CGAN', 'infoGAN', 'ACGAN', 'EBGAN', 'BEGAN', 'WGAN', 'WGAN_GP','WGAN_GP_ADV','WGAN_GP_ADV_vgg', 'DRAGAN','DRAGAN_adv', 'LSGAN'],
...
def main():
    ...
    if args.gan_type  == 'GAN':
        ...
        gan = WGAN_GP(args)
    elif args.gan_type == 'WGAN_GP_ADV':
        gan = WGAN_GP_ADV(args)
    elif args.gan_type == 'WGAN_GP_ADV_vgg':
        gan = WGAN_GP_ADV_vgg(args)
