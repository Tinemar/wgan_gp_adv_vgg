...
class WGAN_GP(object):
    ...
    def train(self):
        ...
        for epoch in range(self.epoch):
            ...
            # logging.info("loss_adv_avg_temp%4d|loss_perturb_avg_temp%4d"%(loss_adv_avg_temp,loss_perturb_avg_temp))
            # if '%.4f' % self.loss_adv_avg >= '%.4f' % loss_adv_avg_temp and '%.4f' % self.loss_perturb_avg >= '%.4f' % loss_perturb_avg_temp:
